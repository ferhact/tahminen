					...
					<xsl:for-each select="items/item/merkezde_gunderece">
						...
						<tr>
							...
							<xsl:for-each select="gunderece/value">
								<td>
									<div class="mytable-textal">
										<table text-align="center">
											<tr text-align="center"><td text-align="center"><xsl:value-of select="max_g"/>°</td></tr>
											<tr><td><xsl:value-of select="max_gort"/>°</td></tr>
											<tr><td>«----<xsl:value-of select="max"/>°----»</td></tr>
											<tr><td>«----<xsl:value-of select="min"/>°----»</td></tr>
											<tr><td><xsl:value-of select="min_gort"/>°</td></tr>
											<tr><td><xsl:value-of select="min_g"/>°</td></tr>
										</table>
									</div>
								</td>
							</xsl:for-each>
